...
And it came to pass on the third day after the Octave of Pentecost,
that the prelates, the knights returned from the East, and the brethren of the cloister were gathered in the great temple.

And he who had served upon the front was called before the altar,
not with a light tongue,
but with a steady arm and constant discipline.

He had journeyed through lands of dust and salt.
He had seen walls fall and crosses raised.
And he returned not claiming honor,
but silence.

Then the Archbishop arose and said:

“Judgment is not given to the impetuous,
nor guardianship to the faint of heart.
For it is written that all authority proceeds from above,
and there is no order without foundation.

This son of the Church was instructed within her bosom,
and tested beyond it.
He did not break his vow in absence,
nor seek shelter when examined by iron.

He was found steadfast where others were shaken,
and firm where many yielded.
He did not hasten sentence without cause,
nor delay correction when it was required.”

And having heard testimony from his superiors in war and from his masters in the cloister,
he was declared worthy not by his own word,
but by constancy proven.

Then the Archbishop laid hands upon him and proclaimed:

“Unto thee is conferred the title of Judge of the Threshold,
not for light condemnation,
but for righteous discernment.

Thou shalt stand guard where others falter.
Thou shalt correct where error takes root.
Thou shalt be silent where tumult demands spectacle.

Thou shalt not act from thine own zeal,
but from fidelity to the order thou hast received.
Thou shalt seek no glory in sentence,
nor rest in omission.”

And the people answered:
Amen.

The seal was delivered unto him,
not as an emblem of dominion,
but as a burden.

And it was said:

“Thou returnest not under yoke,
for none is servant of the sanctuary,
but of the will that consecrated it.

Thou returnest as one who keeps the gate
and examines before granting passage.
Thy hand shall not be light,
nor thine ear negligent.”

Then, by command of the celebrant,
brief word was granted unto the invested.

And he said:

“I add no vow to that which I have made.
I shall keep the threshold.
And I shall answer for it.”

And he descended from the presbytery without lifting his gaze.

And thus was it recorded in the greater book of the Priory…

—

Archive of the Greater Scriptorium
...
export const mockItems: Item[] = [
  ...
  {
    id: "20",
    name: "Wolfsbane Ledger",
    slug: "wolfsbane-ledger",
    categoryId: "key_items",
    subcategoryId: "quest_relics",
    lorDescription: "A damp field ledger hidden inside the abandoned mill. It records failed harvests, fever outbreaks, and the first uncontrolled spread of wolfsbane among workers.",
    shortDescription: "Proof of the first wolfsbane contamination near the old mill.",
    imageUrl: "/images/maps/molino-abandonado.jpg",
    rarity: "rare",
    howToObtain: "Found in the Abandoned Mill, between the Meadow and the Haunted Forest.",
  },
  {
    id: "21",
    name: "Field Notes: Wolfsbane",
    slug: "field-notes-wolfsbane",
    categoryId: "key_items",
    subcategoryId: "quest_relics",
    lorDescription: "Placeholder relic. A weathered notebook filled with sketches of sick crops and first-stage wolfsbane symptoms.",
    shortDescription: "Placeholder: early contamination observations from the Meadow.",
    imageUrl: "/images/maps/elden-ring-placeholder.png",
    rarity: "rare",
    howToObtain: "Placeholder: discover it in La Pradera.",
  },
  {
    id: "22",
    name: "Mill Floodgate Key",
    slug: "mill-floodgate-key",
    categoryId: "key_items",
    subcategoryId: "keys",
    lorDescription: "Placeholder key. Iron key tagged with old mill markings and floodgate channels.",
    shortDescription: "Placeholder: opens old water gates near the mill.",
    imageUrl: "/images/maps/molino-abandonado.jpg",
    rarity: "epic",
    howToObtain: "Placeholder: hidden in Molino Abandonado.",
  },
  {
    id: "23",
    name: "Cracked Forest Seal",
    slug: "cracked-forest-seal",
    categoryId: "key_items",
    subcategoryId: "runes",
    lorDescription: "Placeholder rune. A fractured ward-seal recovered from the Haunted Forest floor.",
    shortDescription: "Placeholder: seal fragment with unstable warding glyphs.",
    imageUrl: "/images/maps/elden-ring-placeholder.png",
    rarity: "epic",
    howToObtain: "Placeholder: find it in Bosque Embrujado.",
  },
  {
    id: "24",
    name: "Auremont Relic Fragment",
    slug: "auremont-relic-fragment",
    categoryId: "key_items",
    subcategoryId: "quest_relics",
    lorDescription: "Placeholder relic. A carved fragment bearing the crest of House Auremont.",
    shortDescription: "Placeholder: relic shard tied to Auremont lineage.",
    imageUrl: "/images/maps/elden-ring-placeholder.png",
    rarity: "legendary",
    howToObtain: "Placeholder: recover it in Villa Infestada.",
  },
];
...
export const mockLocations: Location[] = [
  {
    ...
    mapImageUrl: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=1280&h=720&fit=crop",
    mapPosition: { x: 30, y: 62 },
    sightedCharacterSlugs: ["el-perro", "el-escudero"],
    dangerLevel: "high",
    discovered: true,
  },
  {
    ...
    mapImageUrl: "https://images.unsplash.com/photo-1605106702734-205df224ecce?w=1280&h=720&fit=crop",
    mapPosition: { x: 68, y: 30 },
    sightedCharacterSlugs: ["el-juez", "la-doncella", "el-hechicero"],
    dangerLevel: "extreme",
    discovered: true,
  },
  {
    ...
    type: "region",
    loreDescription:
      "Capital eclesiástica que envía a los protagonistas a la campaña. Gran catedral, plazas y bibliotecas con textos históricos y prohibidos. Rumores sobre la Mansión Auremont y criaturas extrañas se filtran entre sus pasillos.",
    shortDescription: "Capital eclesiástica de catedrales, plazas y archivos prohibidos.",
    imageUrl: "/images/maps/elden-ring-placeholder.png",
    mapImageUrl: "/images/maps/elden-ring-placeholder.png",
    mapPosition: { x: 45, y: 80 },
    sightedCharacterSlugs: [],
    dangerLevel: "medium",
    discovered: true,
  },
  {
    ...
    type: "region",
    loreDescription:
      "Cruce simbólico hacia la campaña, transición entre la civilización y lo desconocido. Un río amplio y profundo fluye bajo piedra desgastada mientras la niebla distorsiona la percepción y multiplica reflejos imposibles.",
    shortDescription: "Paso fronterizo envuelto en niebla y reflejos imposibles.",
    imageUrl: "/images/maps/elden-ring-placeholder.png",
    mapImageUrl: "/images/maps/elden-ring-placeholder.png",
    mapPosition: { x: 30, y: 62.5 },
    sightedCharacterSlugs: [],
    dangerLevel: "medium",
    discovered: true,
  },
  {
    ...
    type: "region",
    loreDescription:
      "Pastizales verdes que se extienden hasta colinas boscosas, con ruinas dispersas y abandono silencioso. Casas destruidas, objetos corroídos y campos anómalos de maíz y girasoles anuncian que el lugar ya no responde a reglas normales.",
    shortDescription: "Llanura en ruinas donde la vida pasada quedó suspendida.",
    imageUrl: "/images/maps/elden-ring-placeholder.png",
    mapImageUrl: "/images/maps/elden-ring-placeholder.png",
    mapPosition: { x: 30, y: 40 },
    sightedCharacterSlugs: [
      "semihumanos",
      "gallo-de-tres-cabezas",
      "aguijones-del-valle",
      "golems-de-la-cosecha",
      "cabezas-de-cosecha",
      "pestiferos",
  ...
  {
    id: "103a",
    name: "Molino Abandonado",
    slug: "molino-abandonado",
    type: "region",
    loreDescription:
      "Molino de piedra detenido entre la Pradera y el Bosque Embrujado. En sus vigas y campos cercanos aparecen los primeros indicios de infección por wolfsbane: flores fuera de estación, polen denso y manchas que avanzan sobre madera y grano.",
    shortDescription: "Ruina fronteriza con los primeros brotes de wolfsbane.",
    imageUrl: "/images/maps/molino-abandonado.jpg",
    mapImageUrl: "/images/maps/molino-abandonado.jpg",
    mapPosition: { x: 32.4, y: 35.8 },
    sightedCharacterSlugs: ["podredumbre-andante", "pestiferos"],
    dangerLevel: "high",
    discovered: true,
  },
  {
    ...
    slug: "bosque-embrujado",
    type: "region",
    loreDescription:
      "Bosque denso donde naturaleza y oscuridad se mezclan. Piedras levitan, luces flotan entre raíces laberínticas y ecos nocturnos rompen un silencio sepulcral que confunde orientación y juicio.",
    shortDescription: "Bosque oscuro con fenómenos de levitación y apariciones.",
    imageUrl: "/images/maps/elden-ring-placeholder.png",
    mapImageUrl: "/images/maps/elden-ring-placeholder.png",
  ...
  {
    id: "105",
    name: "Villa Infestada",
    slug: "villa-infestada",
    type: "region",
    loreDescription:
      "Asentamiento cubierto por flores de wolfsbane, con casas invadidas por vegetación y calles silenciosas. De noche, espíritus flotan bajo la luna mientras el trazado urbano parece mutar.",
    shortDescription: "Villa tomada por flora invasiva y presencias nocturnas.",
    imageUrl: "/images/maps/elden-ring-placeholder.png",
    mapImageUrl: "/images/maps/elden-ring-placeholder.png",
    mapPosition: { x: 57, y: 28 },
    sightedCharacterSlugs: ["licantropos", "podredumbre-andante"],
    dangerLevel: "high",
    discovered: true,
  },
  {
    id: "106",
    name: "Ruinas del Monasterio",
    slug: "ruinas-del-monasterio",
    type: "dungeon",
    loreDescription:
      "Antiguo monasterio que oculta el acceso a la Mansión Auremont. Claustros vacíos, criptas y jardines descuidados conservan una calma artificial interrumpida por cadáveres de monjes cubiertos en mantas.",
    shortDescription: "Monasterio abandonado con pasadizos secretos a la mansión.",
    imageUrl: "/images/maps/elden-ring-placeholder.png",
    mapImageUrl: "/images/maps/elden-ring-placeholder.png",
    mapPosition: { x: 63.5, y: 20 },
    sightedCharacterSlugs: ["esfinge"],
    dangerLevel: "high",
    discovered: true,
  },
  {
    id: "107",
    name: "Mansión Auremont",
    slug: "mansion-auremont",
    type: "dungeon",
    loreDescription:
      "Residencia del linaje Auremont donde tiempo y espacio se deforman según las obsesiones de sus dueños. Pasillos imposibles, salas de ilusiones y laboratorios vivos convierten la torre en una entidad protectora y posesiva.",
    shortDescription: "Torre alquímica de geometría imposible y voluntad propia.",
    imageUrl: "/images/maps/elden-ring-placeholder.png",
    mapImageUrl: "/images/maps/elden-ring-placeholder.png",
    mapPosition: { x: 70, y: 32.5 },
    sightedCharacterSlugs: [
      "ruth",
      "dragon-guardian-de-entrada",
      "sirvientes-fantasmales",
      "mayordomos-locos",
      "armaduras-reaimadas",
      "bestias-de-laboratorio",
      "sirenas-de-acero",
    ],
    dangerLevel: "extreme",
    discovered: true,
  ...
  {
    id: "108",
    name: "Mazmorras de la Mansión",
    slug: "mazmorras-de-la-mansion",
    type: "dungeon",
    loreDescription:
      "Prisiones antiguas bajo la mansión, con celdas húmedas, cadenas oxidadas y susurros que nacen de espacios vacíos. Sombras anómalas y olor a hierro marcan un lugar pensado para quebrar la voluntad.",
    shortDescription: "Calabozos olvidados bajo Auremont, saturados de ecos y moho.",
    imageUrl: "/images/maps/elden-ring-placeholder.png",
    mapImageUrl: "/images/maps/elden-ring-placeholder.png",
    mapPosition: { x: 71, y: 36 },
    sightedCharacterSlugs: [
      "carceleros-esqueleticos",
      "prisioneros-malditos",
      "ratas-negras",
      "el-encadenado",
      "miasmas",
  ...
  },
  {
    ...
    type: "dungeon",
    loreDescription:
      "Red de túneles de drenaje convertida en vertedero alquímico y cárcel oculta. El agua estancada absorbe la luz, los ecos engañan y compuertas móviles alteran rutas de escape.",
    shortDescription: "Túneles húmedos y tóxicos que conectan la prisión con niveles profundos.",
    imageUrl: "/images/maps/elden-ring-placeholder.png",
    mapImageUrl: "/images/maps/elden-ring-placeholder.png",
    mapPosition: { x: 72, y: 40 },
    sightedCharacterSlugs: ["sirvientes-deformados", "garrapatas-de-sangre", "ratas-albinas-gigantes", "carroneros-gusanos"],
    dangerLevel: "extreme",
    discovered: true,
  },
  {
    ...
    slug: "las-profundidades",
    type: "secret",
    loreDescription:
      "Más allá de las alcantarillas se abre un abismo vivo alrededor de ruinas imposibles. La oscuridad engulle la luz, la piedra late y un dios sepultado distorsiona el tiempo, la materia y la memoria.",
    shortDescription: "Núcleo maldito bajo la mansión: templo roto y abismo consciente.",
    imageUrl: "/images/maps/elden-ring-placeholder.png",
    mapImageUrl: "/images/maps/elden-ring-placeholder.png",
    mapPosition: { x: 73, y: 45 },
    sightedCharacterSlugs: [
      "culto-del-abismo",
      "carroneros-de-hueso",
      "los-encadenados",
      "larvas-abismales",
      "el-heraldo-del-vacio",
      "el-dios-sepultado",
    ],
    dangerLevel: "extreme",
    discovered: true,
...
export const mockLocaciones: Locacion[] = mockLocations.map((loc) => ({
  ...
  personajes_avistados_slugs: loc.sightedCharacterSlugs,
