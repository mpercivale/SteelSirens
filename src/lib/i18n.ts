...
const characterCircleLocales: Record<Language, Record<string, CharacterCircleLocaleEntry>> = {
  ...
  es: {
    "el-perro": {
      ...
      quotes: ["Mantén tu moneda cerca y tu hoja aún más cerca.",
" He visto cosas peores… apenas.",
" El chico tiene más agallas que sentido común.",
" ¿Confianza? Ese es un lujo para los muertos.",
" Un trabajo más, eso es lo que siempre dicen…",
" No prometí ser un santo."],
    },
    "el-escudero": {
      name: "El Escudero",
...
"Prometí que sería valiente.",
"¿Así es como se siente el coraje?"],
    },
    "la-doncella": {
      name: "La Doncella",
    ...
    "el-juez": {
      ...
      quotes: ["«La misericordia suele confundirse con virtud.»",
        "«La guerra revela lo que la oración se niega a responder.»",
        "«La misericordia a menudo se confunde con virtud.»",
        "«No doy forma al destino. Lo hago cumplir.»",
        "«No hay pecado en la supervivencia, solo necesidad.»",
        "«Soy la mano que da forma al destino.»",
        "«La torre llama a quienes entienden el poder.»"],
    },
    "el-hechicero": {
      name: "El Hechicero",
  ...
  ja: {
    ...
    "la-doncella": {
      name: "乙女",
      title: "空虚の姫",
      quotes: ["...あたたかい...", "...家...", "...暖かさ...", "...希望..."],
    },
    "el-juez": {
      name: "裁き手",
      title: "審判の先触れ",
      quotes: ["慈悲はしばしば徳と取り違えられる。",
        "戦争は祈りが答えることを拒むものを明らかにする。",
        "慈悲はしばしば徳と取り違えられる。",
        "私は運命を形作るのではない。私はそれを実行する。",
        "生き残ることに罪はない、必要なだけだ。",
        "私は運命を形作る手だ。"],
    },
    "el-hechicero": {
