...
import CharactersGrid from "@/components/game/CharactersGrid";
import { getCharactersCopy, resolveLanguage } from "@/lib/i18n";
...
export default async function CharactersPage({ searchParams }: Props) {
  ...
  const pageCopy = getCharactersCopy(lang);
    ...
    <div className="relative min-h-screen bg-[oklch(0.08_0.005_260)]" lang={lang}>
      ...
      <main className="relative z-10 pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <CharactersGrid
            characters={mockPersonajes}
            lang={lang}
            protagonistLabel={pageCopy.protagonist}
          />
        </div>
      </main>
      <Footer />
