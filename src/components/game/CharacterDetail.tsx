                    ...
                    {isMaidenChronicleCards ? (
                      <div className="space-y-6">
                        {chronicleSections.map((section, index) => (
                          ...
                          >
                            <div className="w-full md:w-[80%] border border-amber-500/35 bg-gradient-to-b from-amber-500/38 via-amber-700/16 to-black/92 backdrop-blur-sm rounded-none overflow-hidden shadow-[0_0_0_1px_rgba(0,0,0,0.35)]">
                              <div className="p-4 text-left">
                                <p className="text-xs uppercase tracking-[0.2em] text-amber-300/90 font-extrabold drop-shadow-sm">
                                  {sealedLetterLabel}
                                </p>
                                  ...
                                  <div className="p-4 pt-1">
                                    ...
                                    {isCardLong && (
                                      <Button
                                        ...
                                        className="mt-4 rounded-none border-amber-500/45 bg-amber-500/35 text-black hover:bg-amber-500/45 hover:text-black font-serif font-semibold uppercase tracking-[0.14em] px-5 py-2 h-auto skew-x-[-14deg] transition-all duration-200"
                                      >
